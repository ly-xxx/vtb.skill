...
> 把喜欢过、追过、想认真留下来的虚拟主播，整理成一个能安装、能维护、还能继续补料的 `.skill`
...
虚拟主播这件事，有时候很像在和时间抢东西。

很多喜欢，最早只是从一条动态、一段切片、一场游戏直播开始。等你真的想把 TA 留下来时，公开内容已经散在不同平台里，语气、节奏、口癖、直播间的空气感，也很容易在转述里一点点走样。

有人还在继续开播，有人已经很久不更新了，也有人只剩下纪念账号、旧动态和零散录播。正因为这样，把一个 VTuber 做成 `.skill`，才不该只是临时写几句 prompt，而更像一次尽量克制、尽量可复核的整理。

`vtb.skill` 想做的，就是把这段整理过程里最累、最容易返工的部分先铺平。

很多人卡住，不是因为不会写一句像 TA 的话，而是因为前面的活又碎又重：

- 公开来源怎么找、怎么核验
- 动态、投稿、直播间信息怎么一起收
- 哪些公开视频适合转写
- 口癖、梗词和稳定人格骨架怎么分开
- 最后怎么把这些东西整理成一个真能安装、后面还能继续维护的 repo

所以 `vtb.skill` 不做 Live2D、TTS 驱动或直播控场，它主要负责把“蒸馏一个 VTuber.skill”里最适合流程化的部分串起来：
